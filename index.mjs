// Central Bank of Oman exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbo';
...
/** Latest rate for one pair, e.g. getRate('USD', 'OMR', { apiKey }). */
